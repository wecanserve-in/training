  ...
  return (
    <div className="super-dashboard">
      ...
      <section className="dash-stat-cards">
        <Link to="/admin/manage-users" className="stat-card stat-courses" style={{ textDecoration: "none" }}>
      ...
      <section className="dash-four-cards">
        <Link to="/admin/analytics" className="light-summary-card" style={{ textDecoration: "none" }}>
