...
const zoneStats = useMemo(() => {
  ...
  const testPerformance = useMemo(() => {
    ...
    return {
      ...
      average:
        scoredAttempts > 0
          ? Math.round(scoreTotal / scoredAttempts)
          : 0,
    };
  }, [completedCourses]);
          ...
          <div className="department-progress-list">
            {topDepartments.length === 0 ? (
              ...
              topDepartments.map((item) => (
                <div
                  className="department-progress-row"
        ...
        <div className="dash-card zone-summary-card">
          ...
          <div className="zone-summary-grid">
            {zoneStats.map((item) => (
              <Link
                key={item.zone}
                to={`/super-admin/analytics?zone=${encodeURIComponent(item.zone)}`}
              ...
              >
                <div className="zone-summary-heading">
                  <div className="zone-summary-icon">
                    ...
                    <span>
                      {item.userCount} users • {item.completed} of {item.assigned} completed
                    </span>
                  </div>
                </div>
      ...
      <section className="dashboard-insights-row">
        ...
        <div className="dash-card compact-insight-card test-performance-card">
          <div className="insight-card-head">
            ...
            <Link to="/super-admin/results">Results</Link>
          </div>
      ...
      <section className="dash-card latest-course-section">
        <div className="card-head compact-card-head">
          ...
          {expandedCourseId ? (
            ...
            <Link to="/super-admin/assigned-users" className="view-all-link">
              View All
            </Link>
          )}
        </div>
              ...
              latestCourses.map((course) => {
                ...
                return (
                  <button
                    ...
                    aria-label={`View assigned users for ${course.title}`}
                  ...
                  >
                    ...
                    <div className="latest-course-body">
                      ...
                      <span className="latest-course-created">
                        Created by {course.departmentName}
                      </span>
